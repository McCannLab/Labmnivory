...
let
    ...
    # `pulse()` returns first eigen value, degree of overshoot and Max-Min
    # K
    res_K = []
    rg_K = 2.25:0.01:3.75
    for k in rg_K
    ...
    plot(rg_K, [-1/res_K[i][1][2] for (i, K) in enumerate(rg_K)], label = "P", color = col_p)
    ...
    plot(rg_K, [res_K[i][4][3] for (i, K) in enumerate(rg_K)], label = "P", color = col_p)
    ...
    plot(rg_K, [res_K[i][7][3] for (i, K) in enumerate(rg_K)], label = "P", color = col_p)
    ...
    plot(rg_aCP, [-1/res_aCP[i][1][2] for (i, a) in enumerate(rg_aCP)], label = "P", color = col_p)
    ...
    plot(rg_aCP, [res_aCP[i][4][3] for (i, a) in enumerate(rg_aCP)], label = "P", color = col_p)
    ...
    plot(rg_aCP, [res_aCP[i][7][3] for (i, a) in enumerate(rg_aCP)], label = "P", color = col_p)
    ...
    plot(rg_eCP, [-1/res_eCP[i][1][2] for (i, K) in enumerate(rg_eCP)], label = "P", color = col_p)
    ...
    plot(rg_eCP, [res_eCP[i][4][3] for (i, K) in enumerate(rg_eCP)], label = "P", color = col_p)
    ...
    plot(rg_eCP, [res_eCP[i][7][3] for (i, K) in enumerate(rg_eCP)], label = "P",color = col_p)
    ...
    plot(rg_mP, [-1/res_mP[i][1][2] for (i, K) in enumerate(rg_mP)], label = "P", color = col_p)
    ...
    plot(rg_mP, [res_mP[i][4][3] for (i, K) in enumerate(rg_mP)], label = "P", color = col_p)
    ...
    plot(rg_mP, [res_mP[i][7][3] for (i, K) in enumerate(rg_mP)], label = "P", color = col_p)
    ...
    plot(rg_K, [res_K[i][9][2] for (i, K) in enumerate(rg_K)], label = "P", color = col_p)
    ...
    plot(rg_aCP, [res_aCP[i][9][2] for (i, a) in enumerate(rg_aCP)], label = "P", color = col_p)
    ...
    plot(rg_eCP, [res_eCP[i][9][2] for (i, K) in enumerate(rg_eCP)], label = "P", color = col_p)
    ...
    plot(rg_mP, [res_mP[i][9][2] for (i, K) in enumerate(rg_mP)], label = "P", color = col_p)
