...
let
    ...
    sol_omn_responsive_pulse = solve(prob_omn_responsive, reltol = 1e-8, abstol = 1e-8, callback = cb)
    ...
    ## Responsive Omnivory
    eq_omn_responsive = find_eq(sol_omn_responsive[end], par_omn_responsive)
    ...
    chain_OS = [quadgk(t -> chain_overshoot(t)[1], pulse_start, t_end)[1],
                ...
                quadgk(t -> chain_overshoot(t)[3], pulse_start, t_end)[1]]

    omn_fixed_OS = [quadgk(t -> omn_fixed_overshoot(t)[1], pulse_start, t_end)[1],
                    quadgk(t -> omn_fixed_overshoot(t)[2], pulse_start, t_end)[1],
                    quadgk(t -> omn_fixed_overshoot(t)[3], pulse_start, t_end)[1]]

    omn_responsive_OS = [quadgk(t -> omn_responsive_overshoot(t)[1], pulse_start, t_end)[1],
                   quadgk(t -> omn_responsive_overshoot(t)[2], pulse_start, t_end)[1],
                   quadgk(t -> omn_responsive_overshoot(t)[3], pulse_start, t_end)[1]]
    ...
    ### Omnivory [responsive]
    subplot(3, 2, 5)
    plot(sol_omn_responsive_grid.t, sol_omn_responsive_grid[1, :], color = R_col, alpha = 0.5)
    plot(sol_omn_responsive_grid.t, sol_omn_responsive_grid[2, :], color = C_col, alpha = 0.5)
    plot(sol_omn_responsive_grid.t, sol_omn_responsive_grid[3, :], color = P_col, alpha = 0.5)
